...
class Generado{
    ...
    public void st(Token token){
        ...
        else if(token.getLexema().equals("END") || token.getLexema().equals("FUNCTION")){
            this.tokensEsperados.add("END");
            this.tokensEsperados.add("FUNCTION");
    ...
    public void emparejarToken(String token){
        this.analisis.emparejar(token);
    }

    public void errorSintacticoToken(Set<String> tokensEsperados, String tokenLeido){
        this.analisis.errorSintactico(tokensEsperados, tokenLeido);
    }
