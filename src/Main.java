...
public class Main {
    ...
    private static ArrayQueue<Token> colaTokens = new ArrayQueue<>();
    private static AnalisisSintactico analisis;

    static {
        try {
            analisis = new AnalisisSintactico(colaTokens);
                    ...
                    switch (estado) {
                        case 1:
                            ...
                            if (esPalabraReservada(reservadas, token)) {
                                ...
                                crearToken("id", fila, (columna + colAgregadas));
                                token = "";
                            }
                            token = "";
                            break;
                        case 2:
                            ...
                            if (deltaFunction(estado, cadena.charAt(ac), sim_simple, sim_simple_rechazado, sim_compuesto) == 3) {
                                ...
                                crearToken("fid", fila, (columna + colAgregadas));
                                token = "";
                            } else {
                                sendError(fila, columna);
                            }
